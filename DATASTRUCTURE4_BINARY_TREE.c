...
- NODE_Create(int NODE_Data): Create new node for the Tree, this node has the *LeftChild = *RightChild = NULL 
                              and data = NODE_Data
- void BINARY_TREE_Print(NODE NODE_ROOT, int TREE_Level): Print the Tree into the Terminal
...
{
    NODE NODE_ROOT1 = NULL;
    
    //Initialize the data for the BINARY_TREE
    NODE_Insert(&NODE_ROOT1, 1);
    NODE_Insert(&NODE_ROOT1, 2);
    NODE_Insert(&NODE_ROOT1, 3);
    NODE_Insert(&NODE_ROOT1, 4);
    NODE_Insert(&NODE_ROOT1, 5);
    NODE_Insert(&NODE_ROOT1, 7);
    NODE_Insert(&NODE_ROOT1, 9);
    NODE_Insert(&NODE_ROOT1, 6);
    NODE_Insert(&NODE_ROOT1, 8);
    
    //Print all the BINARY_TREE
    BINARY_TREE_Print(NODE_ROOT1, 0);
    return 0;
}
